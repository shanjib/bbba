...
function getBasePath() {
  ...
  // GitHub Pages: repo is served at /repo-name/, HTML files are one level deep
  // Local dev with a server at root: HTML files are at root
  // We detect by checking if we're on a path with more than 1 segment
  return depth > 1 ? "../" : "./";
}
